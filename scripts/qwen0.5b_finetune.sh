...
#SBATCH --time=0-12:00
#SBATCH --output=finetune_qwen-0.5_%N-%j.out
#SBATCH --array=1,2
...
mkdir -p /home/pvharmo/scratch/Qwen2.5-Coder-0.5B-Instruct/checkpoints

cd /home/pvharmo/llm-gha-eval/finetuning
python finetune.py --model Qwen2.5-Coder-0.5B-Instruct --epochs $SLURM_ARRAY_TASK_ID
