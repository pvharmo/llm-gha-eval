...
def deepdiff_compare(original_workflow, generated_workflow):
    original = yaml.safe_load(original_workflow)
    generated = yaml.safe_load(generated_workflow)
...
def llm_as_a_judge(response, model):
    ...
    res = assistant_evaluator.run(response)
...
def actions_comparison(original_workflow, generated_workflow):
    original = yaml.safe_load(original_workflow)
    generated = yaml.safe_load(generated_workflow)
