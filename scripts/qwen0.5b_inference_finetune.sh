...
#SBATCH --time=0-6:00
#SBATCH --output=inference_finetune_qwen0.5b_%A_%N-%j.out
#SBATCH --array=1,2
...
python inference_vllm.py --model Qwen2.5-Coder-0.5B-Instruct --cpu-offload-gb 0 --finetune e$SLURM_ARRAY_TASK_ID-nAll
